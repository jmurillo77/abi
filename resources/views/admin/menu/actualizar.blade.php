...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-md-6">
            <h1>
                <i class="fas fa-edit text-primary"></i> Editar Menú
            </h1>
        </div>
        <div class="col-md-6">
...
<div class="card card-outline card-primary shadow">
    <div class="card-header">
        <h3 class="card-title">Actualizar información del menú</h3>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('configuracion.menus.update', $menu->IdMenu) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="Ruta" id="Ruta" value="{{ old('Ruta', $menu->Ruta) }}" placeholder="Ej: contacto.dashboard">
                </div>

                <div class="col-md-6 form-group mb-3">
                    <label for="Icono">Icono</label>
                    <input type="text" class="form-control" name="Icono" id="Icono" value="{{ old('Icono', $menu->Icono) }}" placeholder="Ej: fas fa-cog|#0ea5e9">
                </div>

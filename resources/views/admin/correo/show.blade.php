...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-md-6">
            <h1>
                <i class="fas fa-envelope text-primary"></i> Detalle del Correo
            </h1>
        </div>
        <div class="col-md-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">{{ $correo->Correo }}</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-primary card-outline shadow">
                <div class="card-body">
                    <h3 class="profile-username text-center font-weight-bold">{{ $correo->Correo }}</h3>

                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <b>Estado</b>
                            <span class="float-right">{{ $correo->Valido === '1' ? 'Válido' : 'No válido' }}</span>
                        </li>
                    </ul>

                    <div class="d-flex justify-content-between">
                        <a href="{{ route('contacto.correo.index') }}" class="btn btn-default">
                            <i class="fas fa-arrow-left"></i> Volver
                        </a>
                        <a href="{{ route('contacto.correo.edit', $correo->IdCorreo) }}" class="btn btn-primary">

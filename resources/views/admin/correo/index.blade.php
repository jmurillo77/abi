                    ...
                    @foreach ($correos as $correo)
                        <tr>
                            <td style="vertical-align: middle"><a
                                    href="correo/{{ $correo->IdCorreo }}">{{ $correo->IdCorreo }}</a></td>
                                    <td style="vertical-align: middle;">{{ $correo->Correo }}</td>
                            <td width="10px"><a href="correo/{{ $correo->IdCorreo }}" class="btn btn-xs btn-teal mx-1 shadow">
                                <i class="fa fa-lg fa-fw fa-eye"></i></a></td>
                            <td width="10px"><a href="correo/{{ $correo->IdCorreo }}" class="btn btn-xs btn-primary mx-1 shadow">
                                <i class="fa fa-lg fa-fw fa-pen"></i></a></td>
                            <td width="10px"><a href="correo/{{ $correo->IdCorreo }}" class="btn btn-xs btn-danger mx-1 shadow">

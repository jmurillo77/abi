...
<div class="container-fluid">
    ...
    <form action="{{ route('configuracion.users.update', $user->id) }}" method="POST">
        @csrf
        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select name="IdRol" id="IdRol" class="form-control">
                                ...
                                @foreach($roles as $role)
                                    <option value="{{ $role->IdRol }}" {{ (string) old('IdRol', $user->IdRol) === (string) $role->IdRol ? 'selected' : '' }}>
                                        {{ $role->Nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="IdPersona" id="IdPersona" class="form-control">
                                ...
                                @foreach($personas as $persona)
                                    ...
                                    @endphp
                                    <option value="{{ $persona->IdPersona }}" data-nombre="{{ $nombrePersona }}" {{ (string) old('IdPersona', $user->IdPersona) === (string) $persona->IdPersona ? 'selected' : '' }}>
                                        {{ $nombrePersona }}
                                    </option>
                                @endforeach
                            </select>
